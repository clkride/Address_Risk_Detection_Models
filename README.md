...
:-------------------------|:-------------------------:
 ...
 Plot3: Frequency of Suspicious Pattern v/s Number of Address Changes <br/> <br/> The count of number of suspicious people are more <br/>  for number of address changes more that 2.| ![alt text](https://github.com/clkride/Address_Risk_Detection_Models/blob/main/plots/bar_plot_address_changes_by_suspicious_pattern.png?raw=true)
